...
const MobileNav = () => {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border shadow-[0_-8px_24px_-16px_hsl(var(--foreground)/0.35)] md:hidden"
        ...
        {navItems.map((item, index) => {
          ...
          return (
            <Link
              ...
              onPointerDown={active ? undefined : startRouteProgress}
