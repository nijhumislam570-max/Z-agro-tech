  ...
  const exportPlatformData = () => {
    ...
    try {
      const rows = [
        ...
        ['Pending Enrollments', analytics.enrollmentStats.pending.toString()],
        ['Approved Enrollments', analytics.enrollmentStats.approved.toString()],
        ['Completed Enrollments', analytics.enrollmentStats.completed.toString()],
